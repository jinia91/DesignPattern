...
public class Client {
    ...
    public static void main(String[] args) {
        // 외부에서 주입받는다고 가정할때
        changePaymentController(new ApplePayPaymentController(masterCardPaymentService));

        // 클라이언트는 기능부 인터페이스만 알면됨
    ...
    public static void changePaymentController(PaymentController paymentController) {
        Client.paymentController = paymentController;
    }
}
